...
const CompilationContext = createContext({
  ...
  setCurrentFilename: ((_: string) => {
  }) as React.Dispatch<React.SetStateAction<string>>,
  isCompiling: false as boolean,
  setIsCompiling: ((_: boolean) => {
  }) as React.Dispatch<React.SetStateAction<boolean>>,
  isValidSolidity: false as boolean,
  setIsValidSolidity: ((_: boolean) => {
  }) as React.Dispatch<React.SetStateAction<boolean>>,
  noFileSelected: false as boolean,
  setNoFileSelected: ((_: boolean) => {
  }) as React.Dispatch<React.SetStateAction<boolean>>,
  hashDir: '' as string,
  setHashDir: ((_: string) => {
  }) as React.Dispatch<React.SetStateAction<string>>,
  tomlPaths: [] as string[],
  setTomlPaths: ((_: string[]) => {
  }) as React.Dispatch<React.SetStateAction<string[]>>,
  activeTomlPath: '' as string,
  setActiveTomlPath: ((_: string) => {
  }) as React.Dispatch<React.SetStateAction<string>>
})
